-- This is an example of RBAC (Role-Based Access Control) database schema and queries for a shop development system. It includes tables for users, roles, menus, and the relationships between them.
-- 1.shopdev_user
...
INSERT INTO
    shopdev_user
VALUES
    (1, 'admin', 'admin@anonystick.com');

INSERT INTO
    shopdev_user
VALUES
    (2, 'shop', 'shop@anonystick.com');

INSERT INTO
    shopdev_user
VALUES
    (3, 'user', 'user@anonystick.com');
...
FROM
    ...
    (
        SELECT
            rome.menu_id
        FROM
            shopdev_user_role usro,
            shopdev_role_menu rome
        WHERE
