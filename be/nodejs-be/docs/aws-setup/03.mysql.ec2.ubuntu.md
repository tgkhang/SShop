...
## 8. Tạo User và Quản lý Quyền (QUAN TRỌNG!)
...
### 8.2. Tạo User cho Local Access (Ứng dụng trên cùng server)
...
### 8.3. Tạo User cho Remote Access
...
** Port 3306 trong AWS Security Group** (xem chi tiết ở file [03.mysql.ec2.al2023.md](./03.mysql.ec2.al2023.md) section 6.4)

### 8.4. Test Remote Connection
...
## 9. Import dữ liệu từ file SQL

### 9.1. Chuẩn bị file SQL

Giả sử bạn có file `mysqlsampledatabase.sql` trên máy local.

### 9.3. Copy file SQL từ local lên EC2
...
**Bước 3:** Tạo database và import (create database nếu chưa có, file SQL có thể đã chứa lệnh này)
...
### 9.6. Import với progress bar (cho file lớn)
...
## 13. So sánh lệnh Ubuntu vs Amazon Linux
